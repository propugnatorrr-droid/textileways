...
export const productFamilies: ProductFamily[] = [
  ...
  },
  {
    ...
    introduction: [
      "As an activewear manufacturer based in Pakistan, TextileWays treats performance apparel as a fabric and construction problem before it is a design one. Sportswear is judged in use rather than on a hanger: a training top has to move with the wearer, manage moisture, survive frequent laundering and keep its graphics intact.",
    ...
    seo: {
      title: "Activewear Manufacturer in Pakistan | Sportswear",
      description:
        "Activewear manufacturer in Pakistan producing performance apparel and team kit, with sublimated graphics, flatlock construction, stretch recovery testing and per piece personalisation.",
      h1: "Activewear manufacturer in Pakistan: sportswear and team kit",
    },
    facets: {
  ...
  },
  {
    ...
    introduction: [
      "As a uniform manufacturer based in Pakistan, TextileWays builds for a different brief than fashion buyers work to. A uniform buyer is not buying a season, they are buying a programme that has to look identical when a new employee is issued a garment three years after the first order.",
    ...
    seo: {
      title: "Uniform Manufacturer in Pakistan | Workwear",
      description:
        "Uniform manufacturer in Pakistan building programmes for consistency across reorders, with retained colour standards, laundering performance testing and durable construction.",
      h1: "Uniform manufacturer in Pakistan: workwear programmes",
    },
    facets: {
