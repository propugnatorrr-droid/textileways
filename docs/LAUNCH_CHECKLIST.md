...
| 1.4 | Images replaced | Partial | All 63 slots are installed: the original 35 (27 passed review outright, 7 remain interim pending a cleaner regeneration, see `docs/IMAGE_MANIFEST.md` section 3), plus 28 more added and installed 2026-09-10 for the Capabilities, Materials, Industries and Markets hubs and detail pages, all 28 of which passed review outright (see `docs/IMAGE_MANIFEST.md` section 8). Marked Partial rather than Done because of the 7 interim images from the original batch, not because of anything in batch 2. |
