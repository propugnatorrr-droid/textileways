...
| 1.4 | Images replaced | Partial | The original 35 slots are all installed (27 passed review outright, 7 remain interim pending a cleaner regeneration, see `docs/IMAGE_MANIFEST.md` section 3). 28 more slots, added 2026-09-10 for the Capabilities, Materials, Industries and Markets hubs and detail pages, are outstanding; paste-ready prompt is `docs/GPT_IMAGE_2_BATCH_2_MASTER_PROMPT.md`. None of these 28 need real facility photography specifically (products, materials, industry-relevant garments), so they can be generated independently of the factory photography project. |
